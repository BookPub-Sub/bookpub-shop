package com.nhnacademy.bookpubshop.aspect;
...
public class LoggingAspect {
     ...
     * 요청 Method, uri 로깅.
     */
    @Before("execution(* com.nhnacademy.bookpubshop.*.controller..*(..))")
     ...
     */
    @AfterReturning(pointcut = "execution(* com.nhnacademy.bookpubshop.*.controller..*(..))", returning = "result")
    ...
    @AfterReturning(pointcut =
            "execution(* com.nhnacademy.bookpubshop.error.ShopAdviceController..*(..))", returning = "result")
